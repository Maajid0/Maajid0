...
## 🚀 Current Projects:
- **End-to-End ECS Deployment**: Deploying an app on AWS ECS using Terraform and GitHub Actions. This project involves creating infrastructure as code, automating deployments, and managing resources on AWS.
- **Flask App with MySQL and Redis**: Building a scalable web application using Flask, MySQL for database management, and Redis for caching to improve performance.
- **Upcoming EKS Project**: Preparing for a Kubernetes-based project with Amazon EKS, focusing on managing containerised applications at scale and automating deployments.
